...
args_1 = "FluRate=NotElevated"
args_2 = "RoommateHasFlu=No"
...
if len(args_1) == 2 and len(args_2) == 0:
	result = Calculation_20(args_1, Nodes)
if len(args_1) == 2 and len(args_2) == 1:
	result = Calculation_20(args_1, args_2, Nodes)
if len(args_1) == 1 and len(args_2) == 1:
	result = Calculation_11(args_1, args_2, Nodes)
if len(args_1) == 3 and len(args_2) == 0:
	result = Calculation_1(args_1, args_2, Nodes)
if len(args_1) == 1 and len(args_2) == 2:
	result = Calculation_12(args_1, Nodes)
